 ...
 * shadcn/studio, organisé par catégories. Source de la grille et des
 * pages composant.
 */
export const CATALOG: CatalogEntry[] = [
  // ─── Formulaire ───
  { slug: 'button', name: 'BandaButton', base: '<button>', category: 'Formulaire', phase: 'A', Demo: ButtonDemo, note: '6 variantes × 4 tailles + 17 modèles dont 12 animés' },
  { slug: 'input', name: 'BandaInput', base: '<input>', category: 'Formulaire', phase: 'A', Demo: InputDemo, note: 'sanitize + validate + 13 modèles (add-ons, password, search, stepper…)' },
  { slug: 'select', name: 'BandaSelect', base: '<select>', category: 'Formulaire', phase: 'A', Demo: SelectDemo, note: 'parité shadcn (38 variantes) en 100 % custom : groupes, séparateurs, icônes, avatars, multi, listbox, labels décorés, 2 animations' },
  { slug: 'textarea', name: 'BandaTextarea', base: '<textarea>', category: 'Formulaire', phase: 'A', Demo: TextareaDemo, note: 'sanitize par défaut' },
  { slug: 'label', name: 'BandaLabel', base: '<label>', category: 'Formulaire', phase: 'A', Demo: LabelDemo },
  { slug: 'checkbox', name: 'BandaCheckbox', base: '<input type=checkbox>', category: 'Formulaire', phase: 'A', Demo: CheckboxDemo },
  { slug: 'radio', name: 'BandaRadio', base: '<input type=radio>', category: 'Formulaire', phase: 'A', Demo: RadioDemo },
  { slug: 'switch', name: 'BandaSwitch', base: 'checkbox + role=switch', category: 'Formulaire', phase: 'A', Demo: SwitchDemo },
  { slug: 'form', name: 'BandaForm + smart fields', base: '<form>', category: 'Formulaire', phase: 'A', Demo: FormDemo, note: 'FormData natif ou moteur Zod + @banda/fields ; card, header, actions' },
  ...
  { slug: 'phone-input', name: 'BandaPhoneInput', base: '<input type=tel>', category: 'Formulaire', phase: 'B', note: 'logique déjà dans @banda/fields' },
  ...
  // ─── Surfaces & overlays ───
  { slug: 'card', name: 'BandaCard', base: '<article>', category: 'Surfaces & overlays', phase: 'C', Demo: CardDemo, note: 'composée (Header/Title/Description/Body/Footer) + modèles animés GlowCard/TiltCard' },
  { slug: 'dialog', name: 'BandaDialog', base: '<dialog>', category: 'Surfaces & overlays', phase: 'C', Demo: DialogDemo, note: 'tailles + fullscreen, corps défilant, AlertDialog (icône, destructive), 2 animations' },
  { slug: 'toast', name: 'BandaToast', base: '<aside role=status>', category: 'Surfaces & overlays', phase: 'C', Demo: ToastDemo, note: 'aside role=status, 4 variants, file d’attente' },
  ...
  { slug: 'dropdown-menu', name: 'BandaDropdownMenu', base: '<menu>', category: 'Surfaces & overlays', phase: 'C', Demo: DropdownMenuDemo, note: 'composé (Item, CheckboxItem, RadioGroup…), focus roving, items riches, 2 animations' },
  ...
  { slug: 'tabs', name: 'BandaTabs', base: 'role=tablist', category: 'Navigation', phase: 'D', Demo: TabsDemo, note: '4 variantes × 2 orientations, icônes start/top, badges, clavier APG' },
  { slug: 'menubar', name: 'BandaMenubar', base: '<menu>', category: 'Navigation', phase: 'D' },
  { slug: 'stepper', name: 'BandaStepper', base: '<ol>', category: 'Navigation', phase: 'D', Demo: StepperDemo, note: '2 orientations, labels bottom/end, filled/outline, icônes, hook useStepper' },
  { slug: 'command', name: 'BandaCommand', base: '<dialog> + <input>', category: 'Navigation', phase: 'D', note: 'palette sanitizée' },

  // ─── Affichage de données ───
  { slug: 'typography', name: 'BandaTypography', base: '<h1>…<p>', category: 'Affichage de données', phase: 'E', Demo: TypographyDemo },
  { slug: 'badge', name: 'BandaBadge', base: '<span>', category: 'Affichage de données', phase: 'E', Demo: BadgeDemo, note: 'tone × fill (21 combinaisons) + 8 modèles' },
  { slug: 'table', name: 'BandaTable', base: '<table>', category: 'Affichage de données', phase: 'E', Demo: TableDemo, note: 'base composée + DataTable (sélection, pied de total) + pagination' },
